...
export default function UserUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setIsCompletedKYC(cleanValues.isCompletedKYC);
    setCurrentStateKYC(cleanValues.currentStateKYC);
    setExternalURLKYC(cleanValues.externalURLKYC);
    setHasSigned(cleanValues.hasSigned);
    setDateSigned(cleanValues.dateSigned);
    setIsPaymentProcessing(cleanValues.isPaymentProcessing);
    setUsername(cleanValues.username);
    setIsBanned(cleanValues.isBanned);
    setIsAgent(cleanValues.isAgent);
    setIsSupport(cleanValues.isSupport);
    setErrors({});
  };
